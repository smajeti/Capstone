...
public class LoginActivity extends AppCompatActivity implements
    ...
    private static final int RC_SIGN_IN = 2016;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView signInTxtView = (TextView) findViewById(R.id.sign_in_txt_view);
        signInTxtView.setTypeface(roboto);
    }
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            GlobalDataSingleton.getSingletonInstance().setUserAcctInfo(this, acct);
